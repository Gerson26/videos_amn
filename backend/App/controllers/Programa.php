...
html;
        ...
        // ----- Variables para la primera fecha ----- //
        $info_fecha2 = ProgramaDao::getSectionByDate('2022-09-19');
...
html;
        ...
        $info_fecha3 = ProgramaDao::getSectionByDate('2022-09-20');
...
html;
        ...
        // ----- Variables para la tercera fecha ----- //
        $info_fecha4 = ProgramaDao::getSectionByDate('2022-09-21');
        $programa_fecha4 = <<<html
        <div class="row mb-3">
            <img src="/assets/img/header_programa.png" align="center">
            <h5 class="mb-3 color-green" style="text-align:right;">Miércoles 21 de Septiembre</h5>
        </div>
html;
...
html;
        ...
        // ----- Variables para la cuarta fecha ----- //
        $info_fecha1 = ProgramaDao::getSectionByDate('2022-09-22');
        $programa_fecha1 = '';

        $programa_fecha1 = <<<html
        <div class="row mb-3">
            <img src="/assets/img/header_programa.png" align="center">
            <h5 class="mb-3 color-green" style="text-align:right;">Jueves 22 de Septiembre</h5>
        </div>      
html;
...
html;
        ...
        // ----- Variables para la quinta.1 fecha ----- //
        $info_fecha5 = ProgramaDao::getSectionByDate('2022-09-23');
        $programa_fecha5 = '';

        $programa_fecha5 = <<<html
        <div class="row mb-3">
            <img src="/assets/img/header_programa.png" align="center">
            <h5 class="mb-3 color-green" style="text-align:right;">Viernes 23 de Septiembre Parte 1</h5>
        </div>     
html;
        foreach ($info_fecha5 as $key => $value) {
            $progreso = ProgramaDao::getProgreso($_SESSION['id_registrado'],$value['id_programa']);
...
html;
        ...
        // ----- Variables para la quinta.2 fecha ----- //
        $info_fecha6 = ProgramaDao::getSectionByDate('2022-09-24');
        $programa_fecha6 = '';

        $programa_fecha6 = <<<html
        <hr>
        <div class="row mb-3">
            <img src="/assets/img/header_programa.png" align="center">
            <h5 class="mb-3 color-green" style="text-align:right;">Viernes 23 de Septiembre Parte 2</h5>
        </div>        
html;
        foreach ($info_fecha6 as $key => $value) {
            $progreso = ProgramaDao::getProgreso($_SESSION['id_registrado'],$value['id_programa']);
...
html;
        ...
        View::set('programa_fecha5',$programa_fecha5);
        View::set('programa_fecha6',$programa_fecha6);
    ...
    public function sala_uno(){
        ...
        $info_fecha1 = ProgramaDao::getSectionByDateSala('2022-09-22',1);
        $programa_fecha1 = '';
