...
html;
        ...
        $cursos = TalleresDao::getAsignaProducto($_SESSION['id_registrado']);
        ...
        foreach ($cursos as $key => $value) {
            ...
            $progreso = TalleresDao::getProductProgreso($_SESSION['id_registrado'], $value['id_producto']);
...
html;
            ...
            $like = TalleresDao::getlikeProductCurso($value['id_producto'], $_SESSION['id_registrado']);
            if ($like['status'] == 1) {
                $card_cursos .= <<<html
...
html;
        ...
        $cursos = TalleresDao::getAllProductCursosNotInUser($_SESSION['id_registrado']);
        ...
        foreach ($cursos as $key => $value) {
            ...
            $pendientes_pago = TalleresDao::getProductosPendientesPago($_SESSION['id_registrado'], $value['id_producto'])[0];
...
html;
                    ...
                    $link_parametro_id_registrado = base64_encode($_SESSION['id_registrado']);
                    ...
                    <div class="card-footer">
                        ...
                        <!--<a class="btn btn-primary" href="/OrdenPago/impticket/{$link_parametro_id_registrado}/{$link_parametro_id_producto})" target="_blank" style="margin-right: 5px;margin-left: 5px; width:auto;">Reimprimir orden de pago</a>-->
                        <div style = "display: flex; justify-content:start">
...
html;
        ...
        //CONGRESOS COMPRADOS
        // $cursos = TalleresDao::getAll();
        $cursos = TalleresDao::getAsignaProductoCongreso($_SESSION['id_registrado']);
...
html;
        ...
        $cursos = TalleresDao::getAllProductCongresosNotInUser($_SESSION['id_registrado']);

        $getCostoUser = RegisterDao::getUserById($_SESSION['id_registrado'])[0];
        $costoUser  = $getCostoUser['costo'];
...
html;
        ...
        $productos_pendientes_comprados = HomeDao::getProductosPendComprados($data_user['id_registrado']);
        $checks = '';
        $checked = '';
        $total_productos = 0;
        $total_pago = 0;
        ...
        // // $clave = HomeDao::getProductosPendCompradosClave($data_user['id_registrado'])[0]['clave'];

        // $clave = HomeDao::getLastQrPendientePago($data_user['id_registrado'])['clave'];
        ...
        foreach ($productos_pendientes_comprados as $key => $value) {
            ...
            $count_producto = HomeDao::getCountProductos($data_user['id_registrado'], $value['id_producto'])[0];
            ...
            if ($value['estatus_compra'] == 1) {
                $disabled = 'disabled';
                $checked = 'checked';
                $pend_validar = 'Pagado y validado por AMC';
                // $btn_imp = '';
...
html;
        ...
        $productos_no_comprados = HomeDao::getProductosNoComprados($data_user['id_registrado']);
        ...
        foreach ($productos_no_comprados as $key => $value) {
            ...
            // if ($value['es_congreso'] == 1 && $value['nombre_producto'] == "INSCRIPCIÓN A LA REUNIÓN AL") {
            //     $precio = $value['precio_publico'];
            ...
            if($value['es_congreso'] == 1){
                ...
                $getCosto = HomeDao::getCostoCursosByCategoria($data_user['id_registrado'],$value['id_producto']);
                $precio = $getCosto['costo'];
            }
...
html;
    ...
    public function AsignarCursoSocio()
    {
        ...
        $datos_user = HomeDao::getDataUserById($_SESSION['id_registrado']);
        $clave = $this->generateRandomString();
...
html;
        ...
        $permiso_taller = TalleresDao::getContenidoProdductCursoByAsignacion($_SESSION['id_registrado'], $clave);

        $progreso_curso = TalleresDao::getProductProgreso($_SESSION['id_registrado'], $curso['id_producto']);
        if ($progreso_curso) {
            $progreso_curso = TalleresDao::getProductProgreso($_SESSION['id_registrado'], $curso['id_producto']);
        } else {
            TalleresDao::insertProductCursoProgreso($_SESSION['id_registrado'], $curso['id_producto']);
            $progreso_curso = TalleresDao::getProductProgreso($_SESSION['id_registrado'], $curso['id_producto']);
        }
...
html;
    ...
    public function getNumberPorducts()
    {
        ...
        $getNumberProducts = TalleresDao::getProductsNumber($id_registrado)[0]['total_productos'];
