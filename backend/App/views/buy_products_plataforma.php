    ...
    <main>
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb text-white">
                    <ol class="breadcrumb text-white bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-white"><a class="opacity-10 text-white" href="/Home">Inicio</a></li>
                    </ol>
                </nav>
        ...
        <div class="container-fluid py-0">
            <div class="card col-lg-12 mt-lg-4 mt-1">
                ...
                <div class="card-body px-5 pb-5" style="background-color: #FFF;">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <form class="form_compra" method="POST" action="">
                                                    ...
                                                    <input type="hidden" id="email_usuario" name="email_usuario" value="<?= $datos['email'] ?>">
                                                    <input type="hidden" id="metodo_pago" name="metodo_pago" value="">
                                                    <input type="hidden" id="clave" name="clave" value="<?= $clave ?>">

                                                    <hr>
                                                    <!-- sb-647kud20738837@business.example.com -->
                                            ...
                                            <div class="col-md-6" style="display: flex; justify-content: end;">
                                                ...
                                                <!-- <button class="btn" id="btn_prueba">Prueba</button> -->
                                            </div>
                                        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#btn_prueba").on("click",function(){
                ...
                var urlRegresoPaypal = 'https://congreso.amc.org.mx/OrdenPago/PagoExistoso/?productos='+JSON.stringify(precios);

                $("#return").val(urlRegresoPaypal);

                window.open(urlRegresoPaypal,'_blank');
            });
                                ...
                                $.ajax({
                                    ...
                                    success: function(respuesta) {
                                        ...
                                        if (respuesta.status == 'success') {
                                            ...
                                            Swal.fire("¡Se registro su operación correctamente!", "", "success").
                                            then((value) => {
                                                $(".form_compra").submit();
