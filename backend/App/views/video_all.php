                    ...
                    <div class="row justify-content-center align-items-center">
                        ...
                        <div class="col-sm-auto col-8 my-auto">
                            <div class="h-100">
                                ...
                                <input type="hidden" id="nombre_t2" value="<?php echo $transmision_2['nombre']; ?>" readonly>
                            ...
                            <div class="d-flex mt-4">
                                ...
                                <div class="flex-grow-1 my-auto">
                                    <form class="align-items-center" id="form_chat" method="post">
                                        <input type="hidden" name="id_tipo" id="id_tipo" value="<?= $id_video ?>">
                                        <input type="hidden" name="sala" id="sala" value="1">
                                        <input type="hidden" name="tipo_video" id="tipo_video" value="4">
                                        <div class="d-flex">
                ...
                <div class="card mt-3">
                    <div class="card blur shadow-blur max-height-vh-70">
                        ...
                        <div class="card-footer d-block">
                            ...
                            <progress id="barra_progreso" max="<?php echo $secs_totales; ?>" value="<?php echo $progreso_curso['minutos'] * 60; ?>"></progress>
                            <input type="hidden" name="" id="id_curso" readonly value="<?php echo $id_curso; ?>">
                            <input type="hidden" name="" id="id_video" readonly value="<?php echo $id_video; ?>">
                        </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        // console.log("progreso minutos" +progreso_min);
        // console.log("duracion " + duracion);
        // console.log("porcentaje num "+porcentaje_num);
        ...
        function countTime() {
            intervalo = setInterval(function() {
                ...
                if (tiempo_total % 60 == 0) {
                    ...
                    actualizarProgreso($('#id_video').val(), (inicio / 60));
        ...
        function actualizarProgreso(curso, minutos) {
            $.ajax({
