                ...
                <!-- <div class="card mt-4" id="fiscal-info">
                    <div class="card-header">
                        ...
                        <form class="form-horizontal" id="update_form_fiscal" action="" method="POST">
                            <div class="card-body pt-0">
                                <div class="row">
                                <input id="email_user" name="email_user" maxlength="49" class="form-control" type="hidden" placeholder="example@email.com" onfocus="focused(this)" onfocusout="defocused(this)" value="<?= $userData['email'] ?>">

                                    <div class="col-12 col-sm-4">
                                        <label>Razón Social *</label>
                                        <input class="multisteps-form__input form-control" type="text" id="razon_social" name="razon_social" placeholder="eg. Christopher Prior Jones" maxlength="49" onfocus="focused(this)" onfocusout="defocused(this)" value="<?= $userData['razon_social'] ?>">
                                    </div>                             
                            

                                    <div class="col-12 col-sm-4 mt-1 mt-sm-0">
                                        <label>RFC *</label>
                                        <input class="multisteps-form__input form-control" type="text" id="rfc" name="rfc" placeholder="eg. CPJ41250AS" maxlength="13" onfocus="focused(this)" onfocusout="defocused(this)" value="<?= $userData['rfc'] ?>">
                                    </div>
                                    ...
                                    <div class="col-12 col-sm-5">
                                        ...
                                        <input class="multisteps-form__input form-control" type="text"  id="email_fac" name="email_fac" placeholder="eg. user@domain.com" onfocus="focused(this)" onfocusout="defocused(this)" value="<?= $userData['email_fac'] ?>">
                                        <span class="mb-0 text-sm" id="error_email_send" style="display:none;color:red;">Wrong email</span>
                                    </div>

                                    <div class="col-12 col-sm-6">
                                        <label>Dirección Fiscal * </label>
                                        <input class="multisteps-form__input form-control" type="text"  id="direccion_fiscal" name="direccion_fiscal" placeholder="" onfocus="focused(this)" onfocusout="defocused(this)" value="<?= $userData['direccion_fiscal'] ?>">
                                        <span class="mb-0 text-sm" id="error_email_send" style="display:none;color:red;">Wrong email</span>
                                    </div>
