        ...
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-2">
                    ...
                    <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark" href="/PreCongreso/">PreCongreso</a></li>
                    <li class="breadcrumb-item text-sm">Programa Precongreso</li>
                </ol>
            </nav>
                ...
                <div class="card card-body" id="profile">
                    <div class="row justify-content-center align-items-center">
                        ...
                        <div class="col-sm-auto ms-sm-auto mt-sm-0 mt-3 d-flex">
                                <a href="/PreCongreso/" class="mt-2 me-2 btn-move">
        ...
        <div class="row mt-0 m-auto">
            ...
            <div class="card col-lg-10 mt-lg-3 mt-1" >
                ...
                <div class="card-body p-3">
                    <?php echo $programa_precongreso1; ?>
                    <div class="row">
                        <div class="button-row d-flex mt-4 col-12">
                            <a class="btn bg-gradient-light mb-0 js-btn-prev" href="/PreCongreso/" title="Prev">Regresar</a>
                        </div>
                    </div>
                </div>
            </div>
