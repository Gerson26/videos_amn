    ...
    <div class="container-fluid py-">
        <div class="row mt-0 m-auto">
            ...
            <div class="card-header pb-0 p-3">
                    ...
                    <div style="background-color: #023C8A; border-radius: 20px; height: 30px;"></div>
                    </div>
                    <h4 class="mb-1 mt-4 text-left"><i class="fas fa-chalkboard-teacher"></i> Profesores Ponentes de AMC</h4>
                </div>
