            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm"><a class="opacity-10 text-white" href="javascript:;">Inicio</a></li>
                    </ol>
                </nav>

                <input type="hidden" name="datos" id="datos" value="<?php echo $datos; ?>">
                <input type="hidden" name="porcentaje_beca" id="porcentaje_beca" value="<?php echo $datos['porcentaje_beca']; ?>">
            ...
            <div class="row">
                <div class="col-xl-12 mt-xl-0 mt-0">
                    <div class="row mt-md-4 mt-0">
                        ...
                        <div class="col-6 m-auto m-md-0 col-lg-3 col-md-4 my-md-3 mt-4" style="<?php echo $botonPendientes; echo $btnPendienteAndComprobante; ?>" id="btn_comprobante_pago">
                            <a href="/ComprobantePago/">
                                <div class="card card-link btn-menu-home m-auto" style="background-image: url(/img/SMNP_Iconos/11.png); background-size: contain;">
                                    <div class="mt-md-9 text-center">
                                        <div class="col-12 text-center boton-card">
                                            Comprobante de pago
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-6 m-auto m-md-0 col-lg-3 col-md-4 my-md-3 mt-4" style="<?php echo $botonPagar; echo $btnPendienteAndComprobante;?>" id="btn_abrir_modal_pago">
                            <a href="/Talleres/byProducts" id="xabrir_modal_pagox" data-bs-toggle="xmodalx" data-bs-target="x#modal-pagar-inscripcionx">
                                <div class="card card-link btn-menu-home m-auto" style="background-image: url(/img/SMNP_Iconos/Mesa_de_trabajo_11.png);background-size: contain;  object-position: center center;">
                                    <div class="mt-md-9 text-center">
                                        <div class="col-12 text-center boton-card">
                                            Comprar Congreso y Talleres Transcongreso
                                        </div>
                                    </div>
                                </div>
                            </a>
                        ...
                        <div class="col-6 m-auto m-md-0 col-lg-3 col-md-4 my-md-3 mt-4" style="<?=$mostrarBotones?>">
                            <!-- <a href="/Transmission/sala/1"> -->
                            <a href="/Programa/">
                                <div class="card card-link btn-menu-home m-auto" style="background-image: url(/img/SMNP_Iconos/3_1.png);background-size: contain;  object-position: center center;">
                                    <div class="mt-md-9 text-center">
                                        <div class="col-12 text-center boton-card">
                                        Programa
                                        </div>
                        ...
                        <div class="col-6 m-auto m-md-0 col-lg-3 col-md-4 my-md-3 mt-4" style="<?=$mostrarBotones?>">
                            <a href="#">
                                <div class="card card-link btn-menu-home m-auto" style="background-image: url(/img/SMNP_Iconos/7_1.png);background-size: contain;  object-position: center center;">
                                    <div class="mt-md-9 text-center">
                                        <div class="col-12 text-center boton-card-t">
                                            Transmision
                                        </div>
...
<!-- 
                        <div class="col-6 m-auto m-md-0 col-lg-3 col-md-4 my-md-3 mt-4" style="<?=$mostrarBotones?>">
                            <a href="/programa/">
                                <div class="card card-link btn-menu-home m-auto" style="background-image: url(/img/SMNP_Iconos/3_1.png);background-size: contain;  object-position: center center;">
                                    <div class="btn boton-card card-body mt-md-3 text-center content-card-home">
                                        <div class="col-12 text-center">
                                            <br> Programa
                                        </div>
                        ...
                        <div class="col-6 m-auto m-md-0 col-lg-3 col-md-4 my-md-3 mt-4" style="<?=$mostrarBotones?>">
                            <a href="/PreCongreso/">
                                <div class="card card-link btn-menu-home m-auto" style="background-image: url(/img/SMNP_Iconos/cursos_precongreso.png);background-size: contain;  object-position: center center;">
                                    <div class="mt-md-9 text-center">
                                        <div class="col-12 text-center boton-card">
                                            Cursos Precongreso
                                        </div>
                        ...
                        <div class="col-6 m-auto m-md-0 col-lg-3 col-md-4 my-md-3 mt-4" style="<?=$mostrarBotones?>">
                            <a href="/Profesores/">
                                <div class="card card-link btn-menu-home m-auto" style="background-image: url(/img/SMNP_Iconos/profesores.png);background-size: contain;  object-position: center center;">
                                    <div class="mt-md-9 text-center">
                                        <div class="col-12 text-center boton-card">
                                            Profesores
                                        </div>
                        ...
                        <div class="col-6 m-auto m-md-0 col-lg-3 col-md-4 my-md-3 mt-4" style="<?=$mostrarBotones?>">
                            <a href="#" id="abrir-apoyos" data-bs-toggle="modal" data-bs-target="#modal-apoyos-industria">
                                <div class="card card-link btn-menu-home m-auto" style="background-image: url(/img/SMNP_Iconos/area_c.png);background-size: contain;  object-position: center center;">
                                    <div class="mt-md-9 text-center">
                                        <div class="col-12 text-center boton-card">
                        ...
                        <input type="hidden" id="costo_curso" name="costo_curso" value="<?=$costo_congreso?>">
    ...
    <div class="modal fade" id="modal-pagar-inscripcion" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal-pagar-inscripcion">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <span type="button" class="btn bg-gradient-danger" data-bs-dismiss="modal" aria-label="Close" id="close_modal_inscripcion">
                        X
                    </span>
                </div>
                    ...
                    <form class="form_compra" method="POST" action="" target="_blank">
                        <div class="row">
                            <div class="col-12">
                                ...
                                <input type="hidden" value="<?=$datos['email']?>" name="email_modal" id="email_modal">
    ...
    <div class="modal fade" id="modal-apoyos-industria" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal-apoyos-industria">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">
                ...
                <div class="modal-body">
                    <center>
                        <img src="/assets/img/postal.jpeg" alt="asd" class="img-fluid">
                    </center>
                </div>
            </div>
        </div>
        ...
        function getDataInscripcion() {
            $.ajax({
                ...
                success: function(respuesta) {
                    ...
                    let costo = $("#costo_curso").val();
                    let total = 0;
                    let valor = 0;
                    if (respuesta.status == 'success') {

                        let porcentaje_beca = $("#porcentaje_beca").val();

                        if(porcentaje_beca < 100){
                            valor = (porcentaje_beca * costo) / 100;
                            total = costo - valor;
                        ...
                        $("#costo").val(total);
                        $("#precio_producto_text").html('$ ' + total);
            ...
            if (tipo == 'Transferencia') {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        setTimeout(function() {
                            $("#close_modal_inscripcion").click();
                            $("#btn_abrir_modal_pago").addClass('d-none');
                            $("#btn_comprobante_pago").addClass('d-block');
