            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm"><a class="opacity-10 text-white" href="/Home/">Inicio</a></li>
                    </ol>
                </nav>
                ...
                <div class="col-xl-12 mt-xl-0 mt-0">
                    <div class="row mt-md-4 mt-0">
                        ...
                        <div class="col-6 m-auto m-md-0 col-lg-3 col-md-4 my-md-3 mt-4" style="<?php echo $botonPendientes; echo $btnPendienteAndComprobante; ?>" id="btn_comprobante_pago">
                            <a href="/PreCongreso/Programa/1/">
                                <div class="card card-link btn-menu-home m-auto" style="background-image: url(/img/SMNP_Iconos/3_1.png); background-size: contain;">
                        ...
                        <div class="col-6 m-auto m-md-0 col-lg-3 col-md-4 my-md-3 mt-4" style="<?php echo $botonPagar; echo $btnPendienteAndComprobante;?>" id="btn_abrir_modal_pago">
                            <a href="/PreCongreso/Programa/2/" id="xabrir_modal_pagox" data-bs-toggle="xmodalx" data-bs-target="x#modal-pagar-inscripcionx">
